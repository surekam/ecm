...
+ (MB_INSTANCETYPE)showBackgroundAddedTo:(UIView *)view animated:(BOOL)animated
{
    MBProgressHUD *hud = [[self alloc] initWithBackgroundView:view];
	[view addSubview:hud];
	[hud show:animated];
	return MB_AUTORELEASE(hud);
}
...
- (id)initWithBackgroundView:(UIView *)view {
